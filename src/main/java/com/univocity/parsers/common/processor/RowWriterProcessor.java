 ...
 * invoke {@link #write(Object, String[], int[])} to convert the input to an array of objects. This array of objects will in turn be handed to the writer to produce a record in the expected format.
 *  
