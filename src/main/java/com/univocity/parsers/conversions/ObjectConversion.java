 ...
 *
 * <p>Extending classes must implement a proper String to <b>T</b> conversion in {@link #fromString(String)}
 * <p>This abstract class provides default results for conversions when the input is null.
 * <p>It also provides a default implementation of {@link #revert(Object)} that returns the result of <i>input.toString()</i> 
 *  
...
public abstract class ObjectConversion<T> implements Conversion<String, T> {
	...
	/**
	 * Creates a Conversion from String to an Object with default values to return when the input is null.
	 * @param valueIfStringIsNull default value of type <b>T</b> to be returned when the input String is null. Used when {@link #execute(String)} is invoked.
	 * @param valueIfObjectIsNull default String value to be returned when an input of type <b>T</b> is null. Used when {@link #revert(Object)} is invoked.
	 */
	 ...
	 * @return the conversion result, or the value of {@link #valueIfStringIsNull} if the input String is null.
	 */
	@Override
	 ...
	 * @return the conversion result, or the value of {@link #valueIfObjectIsNull} if the input object is null.
	 */
	@Override
	...
	/**
	 *returns a default value of type <b>T</b> to be returned when the input String is null. Used when {@link #execute(String)} is invoked. 
	...
	/**
	 * returns default String value to be returned when an input of type <b>T</b> is null. Used when {@link #revert(Object)} is invoked.
	...
	/**
	 * defines a default value of type <b>T</b> which should be returned when the input String is null. Used when {@link #execute(String)} is invoked. 
	...
	/**
	 * returns default value of type <b>T</b> which should be returned when the input String is null. Used when {@link #revert(Object)} is invoked.
