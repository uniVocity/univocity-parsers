 ...
 * 
 * <p> The reverse conversion from a Calendar to String (in {@link #revert(Calendar)} will return a formatted String using the date pattern provided in this class constructor
...
public class CalendarConversion extends ObjectConversion<Calendar> {
	 ...
	 * @param valueIfStringIsNull default Calendar value to be returned when the input String is null. Used when {@link #execute(String)} is invoked.
	 * @param valueIfObjectIsNull default String value to be returned when a Calendar input is null. Used when {@link #revert(Calendar)} is invoked.
	 * @param dateFormats list of acceptable date patterns The first pattern in this sequence will be used to convert a Calendar into a String in {@link #revert(Calendar)}. 
	 */
	 ...
	 * @return a formatted date String representing the date provided by the given Calendar, or the value of {@link #getValueIfObjectIsNull()} if the Calendar parameter is null.
	 */
	@Override
	 ...
	 * @return the Calendar instance containing the date information represented by the given String, or the value of {@link #getValueIfStringIsNull()} if the String input is null.
	 */
	@Override
